<template>
    <el-form label-width="100px">
        ...
        <el-form-item label="SPU品牌">
            <el-select placeholder="请你选择品牌" style="width: 200px" v-model="SpuParams.tmId">
        ...
        <el-form-item label="SPU销售属性">
            ...
            <el-button @click="addSaleAttr" :disabled="!saleAttrIdAndValueName" style="margin-left: 10px;"
                type="primary" size="default">添加属性</el-button>
            <!-- table展示销售属性与属性值的地方  -->
            <el-table border style="margin: 10px 0px;" :data="saleAttr">
                ...
                <el-table-column label="销售属性值">
                    ...
                    <template #="{ row, $index }">
                        ...
                        <el-button @click="toEdit(row)" v-else type="primary" size="small"
                            icon="Plus"></el-button>
                    </template>
                </el-table-column>
                <el-table-column label="操作" width="120px">
                    <template #="{ row, $index }">
                        <el-button type="danger" size="small" @click="saleAttr.splice($index, 1)"
