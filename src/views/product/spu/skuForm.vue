        ...
        <el-form-item label="平台属性">
            <el-form :inline="true">
                <el-form-item v-for="(item,index) in attrArr" :key="item.id" :label="item.attrName">
                    <el-select placeholder="请选择" style="width:240px" v-model="item.attrIdAndValueId">
        ...
        <el-form-item label="销售属性">
            <el-form :inline="true">
                <el-form-item v-for="(item,index) in saleArr" :key="item.id" :label="item.saleAttrName">
                    <el-select placeholder="请选择" style="width:240px" v-model="item.saleAttrIdAndValueName">
...
import type { SkuData,SaleAttrResponseData,SpuHasImg, SpuData } from '@/api/product/spu/type';
