    ...
    >
        <el-form>
            <el-form-item label="主题颜色">
                <el-color-picker @change="setColor" v-model="color" show-alpha :predefine="predefineColors" :teleported="false"/>
            </el-form-item>
...
let layouSettingStore = useLayOutSettingStore();
...
const updateRefresh = () => {
    layouSettingStore.refresh = !layouSettingStore.refresh
}
const fullScreen = () => {
